  ...
  return (
    ...
    >
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        Sie so schnell finden. Zusätzlich bietet die App einen Bereich mit
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        Ihrer Einwilligung über die Berechtigungen Ihres Geräts (Art. 6 Abs. 1
        lit. a DSGVO); verweigern oder widerrufen Sie diese Einwilligung, können
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        standortbezogenen Kernfunktionen der App bereitzustellen; Sie können die
        Erfassung ablehnen, indem Sie den Zugriff verweigern oder die
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        Verhinderung des Missbrauchs von Sicherheitsfunktionen der App speichern
        wir entsprechende Daten für zwölf (12) Monate.
      </Text>
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        Zahlungsabwickler, Dienste zur Kontoregistrierung und -authentifizierung
        sowie Webhosting-Dienstleister. Sollten wir künftig zusätzliche
        Dienstleister einsetzen, etwa zur Nutzungsanalyse oder Fehlerdiagnose,
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        Mobilfunkmasten) gemäß der eigenen Datenschutzerklärung von Google. Sie
        können den Standortzugriff hierfür jederzeit in den Geräteeinstellungen
        widerrufen.
      </Text>
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        steuer- oder handelsrechtlichen Gründen). Kein in dieser
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        hin löschen oder deaktivieren wir Ihr Konto und Ihre Daten aus unseren
        aktiven Datenbanken; wir behalten uns vor, bestimmte Informationen zu
        speichern, soweit dies zur Betrugsprävention, Fehlerbehebung,
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        entsprechender Standard etablieren, informieren wir Sie darüber in einer
        aktualisierten Fassung dieser Datenschutzerklärung.
      </Text>
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        sichtbaren Hinweis in der App oder durch eine direkte Benachrichtigung.
      </Text>
      ...
      <Text style={[text.body, styles.paragraph]}>
        ...
        Daten löschen zu lassen. Sie können außerdem Ihre Einwilligung zur
        Verarbeitung jederzeit widerrufen. Diese Rechte können im Einzelfall
        gesetzlich eingeschränkt sein. Um Ihre personenbezogenen Daten
        einzusehen, zu aktualisieren oder löschen zu lassen, kontaktieren Sie
