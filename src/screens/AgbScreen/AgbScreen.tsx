  ...
  return (
    ...
    >
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        kann die App außerdem Signaltöne abgeben oder die Taschenlampe Ihres
        Geräts steuern, um auf sich aufmerksam zu machen oder sich wertvolle
        Zeit zu verschaffen. Die von Ihnen festgelegten Kontaktpersonen können
        Sie über die Standortfreigabe schnell finden. Zusätzlich bietet die App
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        Sie, dass Sie diese Bedingungen gelesen, verstanden und akzeptiert
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        Wer von einem anderen Standort aus zugreift, tut dies
        eigenverantwortlich und ist selbst für die Einhaltung der dort geltenden
        Gesetze zuständig.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        Dienste zuzugreifen und Inhalte, zu denen Sie berechtigten Zugriff
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        verfügen, sie zu übermitteln, dass Sie berechtigt sind, uns die
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        gewählten Benutzernamen entfernen oder ändern, wenn wir ihn als
        unangemessen oder anstößig einstufen.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        widerrufliche, persönliche und nicht übertragbare Lizenz zur Nutzung im
        Rahmen der Dienste. Die Software wird ohne Gewährleistung "wie besehen"
        bereitgestellt; das Nutzungsrisiko tragen Sie.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        gegenüber uns oder den Diensten; die missbräuchliche Nutzung erhaltener
        Informationen zur Belästigung anderer; missbräuchliche Nutzung unseres
        Supports oder falsche Missbrauchsmeldungen; jede Nutzung, die gegen
        geltendes Recht verstößt; unbefugtes Einbetten oder Verlinken der
        Dienste; das Hochladen von Viren oder anderer Schadsoftware;
        automatisierte Nutzung über Skripte, Bots oder Data-Mining-Tools; das
        Entfernen von Urheberrechtshinweisen; das Vortäuschen einer fremden
        Identität; das Hochladen von Materialien zur unbefugten Datensammlung
        (z. B. Spyware); das Stören oder übermäßige Belasten der Dienste oder
        verbundener Netzwerke; die Belästigung oder Einschüchterung unserer
        Mitarbeiter; das Umgehen von Zugriffsbeschränkungen; das Dekompilieren,
        Zurückentwickeln oder Anpassen der Software, soweit gesetzlich nicht
        gestattet; die Nutzung von Scrapern oder Bots zum Zugriff auf die
        Dienste; die Nutzung eines Einkaufsagenten für Käufe; das Sammeln von
        E-Mail-Adressen zu Werbezwecken; sowie die Nutzung der Dienste, um mit
        uns in Wettbewerb zu treten oder für eigene Waren und Dienstleistungen
        zu werben.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        Rechte Dritter verletzen, nicht rechtswidrig, irreführend, obszön oder
        diskriminierend sind, dass Sie über alle notwendigen Rechte an den
        Beiträgen und den darin abgebildeten Personen verfügen, und dass die
        Beiträge insbesondere den Schutz von Minderjährigen nicht verletzen.
        Verstöße können zur Kündigung oder Sperrung Ihres Nutzungsrechts führen.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        Dekompilieren, Zurückentwickeln oder Erstellen abgeleiteter Werke; das
        Entfernen von Eigentumshinweisen; kommerzielle oder anderweitig nicht
        vorgesehene Nutzung; die gleichzeitige Nutzung auf mehreren Geräten oder
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        er Ihnen den gezahlten Kaufpreis erstatten. Sie versichern, sich nicht
        in einem Land zu befinden, das einem US-Embargo unterliegt oder auf
        einer Sanktionsliste steht. Die App-Vertreiber sind Drittbegünstigte
        dieser Lizenz und können ihre Bestimmungen Ihnen gegenüber durchsetzen.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        mehr. Käufe über Websites Dritter erfolgen ausschließlich zwischen Ihnen
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        zu, die Bestandteil dieser Geschäftsbedingungen ist. Die Dienste werden
        in Deutschland gehostet; greifen Sie aus einer Region mit abweichenden
        Datenschutzgesetzen zu, willigen Sie mit der weiteren Nutzung in die
        Übertragung und Verarbeitung Ihrer Daten in Deutschland ein.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        führen. Aus diesen Geschäftsbedingungen ergibt sich keine Verpflichtung
        zu Wartung, Support oder Updates.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        Wohnsitzlandes. Sie und wir unterwerfen uns der nicht ausschließlichen
        Zuständigkeit der Gerichte in Lübeck; Verbraucherschutzansprüche können
        Sie zudem in Ihrem EU-Wohnsitzland geltend machen.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        Verfügbarkeit, Fehlerfreiheit oder Eignung für einen bestimmten
        Zweck. Dieser Ausschluss gilt nicht für Schäden aus der Verletzung
        des Lebens, des Körpers oder der Gesundheit, für Schäden, die auf
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        nicht, dass Ihr Standort korrekt übermittelt wird oder eine
        Kontaktperson rechtzeitig reagiert. Wenden Sie sich in einer akuten
        Notlage immer an die zuständigen Rettungs- oder Notfalldienste
        (110/112).
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        (Kardinalpflichten), deren Erfüllung die ordnungsgemäße Durchführung
        des Vertrags überhaupt erst ermöglicht und auf deren Einhaltung Sie
        regelmäßig vertrauen dürfen, ist unsere Haftung auf den vorhersehbaren,
        vertragstypischen Schaden begrenzt. Im Übrigen ist unsere Haftung für
        leicht fahrlässige Pflichtverletzungen ausgeschlossen. Die
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        diese Geschäftsbedingungen, einer Rechtsverletzung Dritter oder einer
        schädlichen Handlung gegenüber anderen Nutzern entstehen.
      </Text>
      ...
      <Text variant="body" style={styles.paragraph}>
        ...
        Rechte und Pflichten jederzeit an Dritte abtreten. Ist eine Bestimmung
        unwirksam, bleibt die Gültigkeit der übrigen unberührt. Diese
        Geschäftsbedingungen begründen weder ein Joint Venture noch eine
